...
function _prepareIndex(env) {
    ...
    let content = "default-src 'self' gap: https://ssl.gstatic.com https://fonts.gstatic.com; style-src 'self' https://*.googleapis.com 'unsafe-inline'; img-src https://placeholdit.imgix.net http://placehold.it https://notify.bugsnag.com 'self' https://*.gstatic.com https://*.googleapis.com " + endpoint + " data:; " +
